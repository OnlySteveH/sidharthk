...
import uk.co.bigdogconsultants.ribbit.adapters.SectionsPagerAdapter;
...
public class MainActivity extends FragmentActivity implements
	...
	protected DialogInterface.OnClickListener mDialogListener = 
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			case 0:
				...
				Toast.makeText(MainActivity.this, "Just before the breakpoint", Toast.LENGTH_LONG).show();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// At "Saving a Photo to the Gallery", 1:30
		super.onActivityResult(requestCode, resultCode, data);
		
		if(resultCode == RESULT_OK) {
			// add to gallery/album
			...
			if(requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST) {
				...
				if (requestCode == PICK_VIDEO_REQUEST) {
					...
					try {
						...
						Toast.makeText(this,  R.string.video_file_problem, Toast.LENGTH_LONG).show();
						return; 
					} catch (IOException e) {						
						Toast.makeText(this,  R.string.video_file_problem, Toast.LENGTH_LONG).show();
						return;
					...
					if(fileSize > FILE_SIZE_LIMIT) {
						Toast.makeText(MainActivity.this, R.string.file_too_large_error, Toast.LENGTH_LONG).show();
						return; // stop the method now.
					}
